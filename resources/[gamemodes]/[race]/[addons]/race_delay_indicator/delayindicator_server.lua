...
addCommandHandler("cpdelays",
	function(player)
		...
		if players[player] then
			outputChatBox("#FE9F8B[INFO] #EADDB3CP delays are now #FF0000HIDDEN", player, 255, 255, 255, true)
		else
			outputChatBox("#FE9F8B[INFO] #EADDB3CP delays are now #00FF00VISIBLE", player, 255, 255, 255, true)
		end
	end
)
