...
Digital = dxCreateFont("Digital.ttf", 21) 
g_Me = getLocalPlayer()
...
g_Settings = {
	DisplayGauge = true,
	GaugePosition = { 10, g_ScreenSize[2] / 2 - 15 },
	ControlStyle = "nfs",
...
function RenderGauge()
	...
	if not (g_ShowGauge and g_Settings.DisplayGauge) then return end	
	...
	--dxDrawImage(g_Settings.GaugePosition[1] + 45, g_Settings.GaugePosition[2] + 41, 10 , 40, "gauge/nos_arrow.png", nosangle, 0, -11, tocolor(255, 255, 255))

	
	dxDrawText("000", g_Settings.GaugePosition[1] + 21, g_Settings.GaugePosition[2] + 16, 10, 40, tocolor(115, 115, 115), 1, Digital)
	dxDrawText(tostring(math.floor(g_Nos + 0.5)), 74, g_Settings.GaugePosition[2] + 16, g_Settings.GaugePosition[1] + 79, 40, tocolor(255, 255, 255), 1, Digital, "right")
end
