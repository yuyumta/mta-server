...
g_VisiblePickups = {}
g_Objects = {}
msgothic = dxCreateFont("msgothic.ttf")
...
addEventHandler('onClientResourceStart', resourceRoot,
	function()
		...
		g_dxGUI = {
--			ranknum = dxText:create('1', screenWidth - 60, screenHeight - 95, false, 'bankgothic', 1, 'right'),
--			ranksuffix = dxText:create('st', screenWidth - 40, screenHeight - 86, false, 'bankgothic', 1),
			...
			timepassed = dxText:create('0:00:00', screenWidth - 10, screenHeight - 25, false, msgothic, 0.8, 'right'),
			mapdisplay = dxText:create('Map: none', 2, screenHeight - dxGetFontHeight(0.7, 'sans')/2, false, 'sans', 0.7, 'left')
		}
...
--		g_dxGUI.ranksuffix:type('stroke', 2, 0, 0, 0, 255)
		...
		--hideGUIComponents('ranknum', 'ranksuffix', 'checkpoint', 'timepassed')
		hideGUIComponents('checkpoint', 'timepassed')
